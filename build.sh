...
mkdir -p "$IMAGES"
wget -O "$IMAGES"/libv86.js https://copy.sh/v86/build/libv86.js
wget -O "$IMAGES"/v86.wasm https://copy.sh/v86/build/v86.wasm
...
python ./fs2json.py --out "$OUT_FSJSON" "$OUT_ROOTFS_TAR"
